                ...
                <SpotlightCard className="card max-w-full w-full sm:max-w-4xl mx-auto py-6 sm:py-8 px-4 sm:px-6 md:px-8" spotlightColor="rgba(80, 158, 236, 0.12)">
                    ...
                    <StaggeredReveal baseDelay={0.2} staggerDelay={0.12} duration={0.5}>
                        ...
                        <div className="mb-8">
                            ...
                            {/* Use this: I started coding in 8th grade with a basic HTML tutorial. I didn't know it at the time, but I was hooked on a specific kind of problem: the kind where you take something abstract and turn it into something real, something people can actually use. Fifteen years later, that's still what I'm chasing.
                            I studied Computer Science at UBC and graduated with high distinction, but the education I value most came from building things outside the classroom. Co-founding a food-tech startup taught me more about customers than any textbook. A data internship taught me what it feels like to ship work that real stakeholders depend on. An AI engineering role taught me how to build reliable software on top of unpredictable systems.
                            The thread running through all of it is a fascination with how things connect. Technology and business. Code and psychology. Discipline and creativity. I think the most interesting problems live in the gaps between fields, and my career so far has been an experiment in trying to live in those gaps.
                            If I had to describe myself in one word, it would be disciplined. I show up. I finish what I start. And I care about doing the work well, not just doing it fast. Outside of work, I'm probably at the gym, reading something about finance or psychology, or trying to figure out how one thing connects to another. */}
